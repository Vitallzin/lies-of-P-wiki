...
export const whatDLC = {
  description: `Lies of P: Overture é uma prequela dramática do aclamado RPG de ação no estilo Souls, Lies of P. O jogo transporta você para a cidade de Krat em seus últimos
  dias, com a beleza assombrosa da Belle Époque do final do século XIX. Às vésperas do massacre do Puppet Frenzy, você segue um lendário Stalker — um guia misterioso — por 
  histórias não contadas e segredos arrepiante. Como o boneco mortal de Geppetto, você viajará por Krat e seus arredores, descobrirá histórias ocultas e enfrentará batalhas 
  épicas que moldam o passado e o futuro de Lies of P.`,

  description2: `Na pele do Boneco de Geppetto, você se depara com um artefato misterioso que o transporta de volta a Krat, em seus últimos dias de grandeza. À sombra de uma 
  tragédia iminente, sua missão é explorar o passado e desvendar seus segredos sombrios — assombrado por surpresas, perdas e vingança. As escolhas que você faz repercutem no 
  passado e no presente do mundo de Lies of P, revelando verdades ocultas e deixando consequências duradouras.”`,

  description3: `Embarque em uma aventura inesquecível onde a sinfonia do aço se choca com a melodia assombrosa do desconhecido. Atreva-se a desvendar os mistérios do passado, 
  pois no coração das trevas reside a chave para desvendar os segredos de uma história atemporal que renasce.`,

  image: whatDLCimage
  
}

export const howAccess = {
    description: `Para acessar a parte do DLC, você precisará concluir o jogo base até o final do capítulo 9, após derrotar o Mestre de Desfile Corrompido. A partir daí, 
    você perceberá que há um novo item em seu inventário: a Crisálida de Star. Com esse item, você precisará viajar rapidamente até o Caminho do Pilgrim Stargazer, no Distrito 
    de Malum, para assistir a uma nova cena. Uma trilha aparecerá para você seguir até chegar a um Observador das Estrelas enferrujado e coberto de trepadeiras; outra cena 
    começará, na qual P usa a Crisálida da Estrela no Observador das Estrelas para repará-lo. Interaja com o Observador das Estrelas Misterioso e ative-o para iniciar o DLC. `,
    image: howAccessImage
}
...
export const dlcNewGampelay = [
  {
    ...
    seja empurrado em direção ao inimigo e criando uma abertura para realizar um ataque leve.`,
    description2:`O próximo tipo de arma é o arco, a primeira arma de longo alcance introduzida no DLC. Embora não cause muito dano, ele certamente é útil quando é preciso 
    eliminar inimigos menores à distância. Seu ataque leve permite que os jogadores disparem flechas consecutivamente, desde que tenham resistência suficiente; o ataque forte 
